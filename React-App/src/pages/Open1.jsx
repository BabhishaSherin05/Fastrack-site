...
import tree1 from '../assets/pictures/Practice/tree1.webp';
...
const Open1 = () => {
  ...
  const product = {
    id: 2,
    title: "Fastrack Thor Quartz Multifunction Red Dial Metal Strap Watch",
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, padding: '2rem' }}>
        ...
        <p style={{ fontWeight: 'bold', marginTop: '1rem' }}>Dial Color: {product.color}</p>
