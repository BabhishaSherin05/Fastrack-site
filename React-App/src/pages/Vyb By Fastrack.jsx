...
const VybByFastrack = () => {
  return (
    <div>
      ...
      <Location/>
     <div className='watch'>
      <Link to="/" className='one'>Home</Link><b> <i class="bi bi-chevron-double-right"></i>  Vyb By Fastrack</b>
        <hr/>
         <p >63 items found for<b> "Vyb By Fastrack " </b></p>
      <hr/>
